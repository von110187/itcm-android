...
class SearchForProductActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val editTextSearchForProduct: EditText = findViewById(R.id.editTextSearchForProduct)
        ...
        buttonSearch.setOnClickListener {
            val query = editTextSearchForProduct.text.toString().trim()
    ...
    private fun saveSearchHistory(query: String) {
        ...
        if (currentUser != null) {
            ...
            if (!userEmail.isNullOrEmpty()) {
                val historyRef = database.child("product_history").child(userEmail.replace(".", ","))
    ...
    private fun startSearchResultActivity(query: String) {
        val intent = Intent(this, SearchProductResultActivity::class.java)
            ...
            if (!userEmail.isNullOrEmpty()) {
                ...
                val historyListener = object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        val adapter = HistoryAdapter(this@SearchForProductActivity, historyList)
