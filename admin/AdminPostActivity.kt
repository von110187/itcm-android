...
class AdminPostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database.orderByChild("email").addValueEventListener(object : ValueEventListener {
    ...
    inner class PostAdapter(
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if (currentPost != null) {
                ...
                // Retrieve user data and set username
                ...
                textViewUpdate.setOnClickListener {
                    ...
                    val intent = Intent(context, AdminUpdatePostActivity::class.java).apply {
    ...
    ) : ArrayAdapter<Comment>(context, R.layout.admin_comment_item, comments) {

        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            var itemView = convertView
            if (itemView == null) {
                val inflater = LayoutInflater.from(context)
                itemView = inflater.inflate(R.layout.admin_comment_item, parent, false)
            }
    ...
    private fun showCommentDialog(postKey: String) {
        ...
        dialog.setContentView(R.layout.admin_comments_layout)
    ...
    private fun loadComments(postKey: String, listViewComments: ListView) {
        ...
        val commentsListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val adapter = CommentAdapter(this@AdminPostActivity, commentsList)
